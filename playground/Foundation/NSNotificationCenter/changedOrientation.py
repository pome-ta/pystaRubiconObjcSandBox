...
from objc_frameworks.UIKit import UIDeviceOrientationDidChangeNotification
...
class ChangedOrientationViewController(UIViewController):
...
if __name__ == '__main__':
  ...
  main_vc = ChangedOrientationViewController.new()

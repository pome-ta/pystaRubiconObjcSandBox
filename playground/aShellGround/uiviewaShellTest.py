...
class ColorView(UIView):
  ...
  @objc_method
  def initWithCoder_(self, coder: ctypes.c_void_p) -> ObjCInstance:
...
class MainViewController(UIViewController):
  ...
  colorView: ColorView = objc_property()
  ...
  def viewDidLoad(self):
    ...
    #colorView = ColorView.alloc().initWithFrame_(CGRectZero)
    ...
    NSLayoutConstraint.activateConstraints_([
      ...
      colorView.centerYAnchor.constraintEqualToAnchor_(
        safeAreaLayoutGuide.centerYAnchor),
      colorView.widthAnchor.constraintEqualToAnchor_multiplier_(
        safeAreaLayoutGuide.widthAnchor, 0.5),
      colorView.heightAnchor.constraintEqualToAnchor_multiplier_(

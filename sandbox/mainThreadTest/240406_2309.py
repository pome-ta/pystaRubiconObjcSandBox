...
def present_ViewController(myViewController):
  ...
  #navigationController = RootNavigationController.new()
  ...
  controller = myViewController#navigationController
...
class WrapNavigationController:
  '''
  def __init__(self):
    self.navigationController = self.RootNavigationController.new()
  '''

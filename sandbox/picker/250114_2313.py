...
from pyrubicon.objc.api import objc_method, objc_rawmethod, objc_const, at, objc_property
...
_NSForegroundColorAttributeName = ObjCInstance(
...
#print(_NSForegroundColorAttributeName)
#print(type(_NSForegroundColorAttributeName))

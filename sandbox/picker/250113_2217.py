...
from pyrubicon.objc.api import objc_method, objc_rawmethod
...
class PickerViewController(UIViewController):
  ...
  def updateColorSwatchViewBackgroundColor(self):
    #self.colorSwatchView.backgroundColor = UIColor.colorWithRed_green_blue_alpha_(self.redColor, self.greenColor, self.blueColor, 1.0)
    pass

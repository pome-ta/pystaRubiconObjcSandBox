...
def present_viewController(viewController: ObjCInstance,
  ...
  rootViewController.presentViewController_animated_completion_(presentViewController, True, completion)
  #rootViewController.presentViewController_animated_completion_(presentViewController, True, None)

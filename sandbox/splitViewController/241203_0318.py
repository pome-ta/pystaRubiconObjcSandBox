...
'''
prefectures = [
  '東北', '青森', '岩手', '秋田', '宮城', '山形', '福島', '関東', '茨城', '栃木', '群馬', '埼玉', '千葉',
  '東京', '神奈川'
]
...
class PrimaryCollectionViewController(UIViewController,
  ...
  def init(self):
    ...
    #self.collectionView.registerClass_forCellWithReuseIdentifier_(UICollectionViewListCell, self.identifier_str)
  ...
  def viewDidLoad(self):
    ...
    def configurationHandler(_cell: objc_id, _indexPath: objc_id,
      ...
      if indexPath.item:
        ...
        config.textProperties.font = UIFont.preferredFontForTextStyle_(
  ...
  def collectionView_cellForItemAtIndexPath_(self, collectionView,
    ...
    return collectionView.dequeueConfiguredReusableCellWithRegistration_forIndexPath_item_(
      self.cellreg, indexPath, prefectures[indexPath.item])

...
from pyrubicon.objc.runtime import load_library,SEL  #, send_super
...
class AudioEngeneWaveGenerator(NSObject, auto_rename=True):
  ...
  def start(self):
    ...
    self.sourceNode = AVAudioSourceNode.alloc().initWithFormat_renderBlock_(
      inputFormat, renderBlock)

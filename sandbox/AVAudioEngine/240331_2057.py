...
class AudioEngeneWaveGenerator(NSObject, auto_rename=True):
  ...
  '''
  sourceNode = property()
  #renderBlock = property()

  
  #@Block
  @objc_method
  def renderBlock(self, isSilence: ctypes.c_void_p, timestamp: ctypes.c_void_p, frameCount: ctypes.c_void_p, outputData: ctypes.c_void_p) -> OSStatus:
    return 0
